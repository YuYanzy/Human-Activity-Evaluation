...
class Simulation:
    ...
    def plot(self):
        ...
        x, y, z, xyz, time, readable_time_acclero, activity, activity2, data_accelero = prep.read_accelerometer_data()
        lat, lon, speed, accuracy, altitude, heading, time_geo, readable_time_geo, activity, activity2, data_geo = prep.read_geodata()
...
if __name__ == "__main__":
    ...
    geo_file = 'data/log/02_17_02_geo.csv'
    accelero_file = 'data/log/02_17_02_accelero.csv'
